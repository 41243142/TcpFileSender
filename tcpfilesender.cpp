    ...
    : QDialog(parent)
{
    ...
    ipLineEdit->setPlaceholderText(QStringLiteral("請輸入 IP 地址"));
    portLineEdit->setPlaceholderText(QStringLiteral("請輸入端口"));
    ...
    setWindowTitle(QStringLiteral("(版本控制Qt管理)檔案傳送"));
